...
(function () {
  ...
  DC.tools = [
    ...
    { slug: 'nepali-date-difference-calculator', name: 'Nepali Date Difference Calculator', cat: 'datetime', icon: 'clock', aliases: 'nepali bs bikram sambat date difference loan tenure bs ad conversion', blurb: 'Calculate the difference between two Nepali BS dates in years, months and days, with loan tenure, BS↔AD conversion and cruise gratuity estimator.' },
  ...
  DC.relatedArticles = {
    'compound-interest-calculator': ['how-to-calculate-compound-interest', 'cagr-vs-absolute-returns', 'simple-interest-vs-compound-interest'],
    ...
    'budget-50-30-20-calculator': ['50-30-20-budget-rule-indian-salary', 'how-to-calculate-savings-rate'],
    ...
    'retirement-calculator': ['nps-vs-ppf-vs-epf', 'atal-pension-yojana-explained', 'retirement-withdrawal-rate-india'],
    'retirement-withdrawal-calculator': ['retirement-withdrawal-rate-india', 'emi-vs-sip-which-is-better-india'],
    'loan-refinance-calculator': ['home-loan-balance-transfer-refinance-india', 'how-to-reduce-home-loan-emi'],
    ...
    'emi-calculator': ['how-to-reduce-home-loan-emi', 'how-to-calculate-emi-manually', 'emi-vs-sip-which-is-better-india', 'how-to-calculate-loan-interest'],
    'sip-calculator': ['how-much-sip-for-1-crore', 'emi-vs-sip-which-is-better-india', 'how-much-will-10000-grow-compound-interest'],
    'income-tax-calculator': ['how-to-calculate-in-hand-salary-from-ctc', 'hra-exemption-calculation-example', 'income-tax-calculator-india-2025-26'],
    'bond-ytm-calculator': ['bond-yield-vs-ytm-india'],
    'ppf-calculator': ['ppf-calculator-15-years', 'nps-vs-ppf-vs-epf', 'ppf-calculator-guide-india-2025'],
    'nps-calculator': ['nps-vs-ppf-vs-epf', 'atal-pension-yojana-explained', 'retirement-withdrawal-rate-india'],
    'epf-calculator': ['nps-vs-ppf-vs-epf', 'gratuity-calculation-formula-india'],
    'gratuity-calculator': ['gratuity-calculation-formula-india', 'esic-vs-esi-explained'],
    'esi-contribution-calculator': ['esic-vs-esi-explained', 'gratuity-calculation-formula-india'],
    'brokerage-calculator': ['zerodha-vs-upstox-vs-angel-one-brokerage-comparison', 'mutual-fund-expense-ratio-impact-india'],
    'cagr-calculator': ['cagr-vs-absolute-returns', 'how-to-calculate-investment-return'],
    'bmi-calculator': ['bmi-calculator-for-indian-adults'],
    'wedding-budget-planner': ['indian-wedding-cost-city-wise'],
    'baby-cost-calculator': ['first-year-baby-cost-india'],
    'hra-calculator': ['hra-exemption-calculation-example', 'how-to-calculate-in-hand-salary-from-ctc'],
    'stamp-duty-calculator': ['stamp-duty-and-registration-charges-india', 'rent-or-buy-house-2026-india'],
    'personal-loan-calculator': ['credit-card-emi-vs-personal-loan', 'personal-loan-vs-car-loan'],
    'job-switch-decision': ['should-i-switch-jobs-for-20-percent-hike', 'how-to-calculate-in-hand-salary-from-ctc'],
    'salary-hike-negotiator': ['should-i-switch-jobs-for-20-percent-hike'],
    'discount-calculator': ['how-to-calculate-a-discount'],
    'inflation-calculator': ['how-to-calculate-inflation-rate', 'cagr-vs-absolute-returns'],
    'take-home-pay-calculator': ['how-to-calculate-in-hand-salary-from-ctc', 'gross-pay-vs-net-pay'],
    'home-loan-eligibility': ['how-much-home-loan-on-my-salary', 'how-to-reduce-home-loan-emi'],
    'fd-vs-mutual-fund': ['nps-vs-ppf-vs-epf', 'mutual-fund-expense-ratio-impact-india'],
    'car-loan-calculator': ['personal-loan-vs-car-loan', 'how-to-calculate-car-payment', 'how-to-calculate-loan-interest'],
    ...
    'tip-calculator': ['travel-tipping-guide', 'how-to-calculate-tip', 'how-to-calculate-percentage-increase-and-decrease'],
  ...
  DC.blogMeta = {
    ...
    'travel-tipping-guide': { title: 'Tipping Around the World: A Traveler\'s Guide for 2026', desc: 'How much to tip in the USA, India, Japan, Mexico, Europe and beyond — restaurants, hotels, taxis and cruises explained for travelers, with a free travel tip calculator.', icon: 'money' },
